...
　　TTS技术基于ScanSoft_MeiLing语音库，提供整套网站信息无障碍服务模块：十字光标、纯文本、文字放到专用阅读屏（简体，繁体和拼音）、高对比阅读配色器、文字放大缩小、网页放大缩小、全程语音实时朗读等，支持服务治理、监控和追踪，努力为政府网站无障碍改造提供解决方案。
...
### 2022-11-15 无障碍工具条3.2版本更新说明
- 页面重绘兼容vue
- 优化一些功能

### 2023-03-27 无障碍工具条3.2版本更新说明
- 适老化工具上线 [https://www.rrbay.com/wza/wza_elder_tool](https://www.rrbay.com/wza/wza_elder_tool "适老化工具条安装部署")
- 字体放大缩小改为基于浏览器放大缩小
- 修复其它已知bug

### 2023-09-08 无障碍工具条4.0版本更新说明
- 适老化工具新增盲人读屏专用--区域跳转功能
- 新增智能解析接口
- Tab键细节处理
- 工具条快捷键重新设计
- 优化一些功能
...
### 2023-11-26 无障碍工具条4.2版本更新说明
- PC端无障碍工具条指读连读支持段落朗读
- PC端无障碍工具条盲人读屏区域跳转支持tab键切换跳转
- PC端无障碍工具条盲人读屏浮动窗口区域支持Ctrl+↓进入和Ctrl+↑返回区域
- PC端无障碍工具条盲人读屏区域跳转提示支持自定义(修改site/localhost.js配置)
- 优化一些功能

### 2024-02-18 无障碍工具条4.3版本更新说明
- 无障碍工具条在线版本重构
- 支持自定义声音开关
- 十字光标辅助线功能优化
- 页面放大功能优化
...
### 2024-05-28 无障碍工具条4.4版本更新说明
- 无障碍工具条在线版本优化
- 支持自定义虚拟目录
- 不支持ie，需要支持ie浏览器的，请本地部署安装
- 修复已知bug

### 2024-08-16 无障碍工具条4.5版本更新说明
- 无障碍工具条加载两种方案自动切换
- vue无刷新读屏问题
- 图片占位字符长度问题
- 图片链接识别问题
